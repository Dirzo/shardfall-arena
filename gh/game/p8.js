...
HEROES.push(
  { id: 'mar', name: 'Marrowin', title: 'The Bonecaller', role: ['Summoner', 'Ranged'], diff: 2,
    ...
    stats: { hp: 560, hpG: 80, mana: 420, manaG: 34, power: 28, powerG: 3.2, as: .65, range: 440, ms: 300, armor: 12, armorG: 1.8, regen: 2.8 },
  ...
  { id: 'tink', name: 'Tinka', title: 'Gearwright of Cogsbury', role: ['Specialist', 'Ranged'], diff: 3,
    ...
    stats: { hp: 550, hpG: 78, mana: 400, manaG: 32, power: 31, powerG: 3.1, as: .7, range: 470, ms: 305, armor: 12, armorG: 1.8, regen: 2.6 },
...
function spawnPet(owner, kind, x, y, o = {}) {
  ...
  const b = isT ? { hp: 340 + 40 * lvl, power: 13 + 2.1 * lvl + owner.power * .13, range: 420, as: 1, r: 16, armor: 25, ms: 0 }
