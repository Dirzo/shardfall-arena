...
const HEROES = [
  ...
  { id: 'vesp', name: 'Vesper', title: 'Stormcaller of the Spire', role: ['Mage', 'Ranged'], diff: 2,
    ...
    stats: { hp: 560, hpG: 78, mana: 460, manaG: 38, power: 30, powerG: 3.6, as: .66, range: 450, ms: 300, armor: 12, armorG: 1.8, regen: 2.6 },
  ...
  { id: 'oryn', tithe: 3, support: true, bounty: .25, name: 'Oryn', title: 'Grovekeeper of Elderwild', role: ['Support', 'Ranged'], diff: 1,
    ...
    stats: { hp: 600, hpG: 84, mana: 440, manaG: 36, power: 40, powerG: 3.8, as: .66, range: 440, ms: 300, armor: 16, armorG: 2.2, regen: 3.4 },
  ...
  { id: 'sylv', name: 'Sylvane', title: 'Windrunner Ranger', role: ['Marksman', 'Ranged'], diff: 2,
    ...
    stats: { hp: 535, hpG: 78, mana: 330, manaG: 26, power: 37, powerG: 3.2, as: .7, range: 460, ms: 310, armor: 13, armorG: 1.9, regen: 2.8 },
...
const ITEMS = [
  ...
  I('galewind', 'Galewind Cannon', 'legendary', 2800, 'barrage', '#bffff0', { as: .3, crit: .25, msp: .07, range: 40 }, { from: ['sash', 'stormshard'], text: 'Sharpshooter: ranged champions gain +40 attack range.' }),
